...
namespace MauiRfidSample.MVVM.Models
{
    class BarcodeTypes
    {
        private const int ST_NOT_APP = 0x00;
        private const int ST_CODE_39 = 0x01;
        private const int ST_CODABAR = 0x02;
        private const int ST_CODE_128 = 0x03;
        private const int ST_D2OF5 = 0x04;
        private const int ST_IATA = 0x05;
        private const int ST_I2OF5 = 0x06;
        private const int ST_CODE93 = 0x07;
        private const int ST_UPCA = 0x08;
        private const int ST_UPCE0 = 0x09;
        private const int ST_EAN8 = 0x0a;
        private const int ST_EAN13 = 0x0b;
        private const int ST_CODE11 = 0x0c;
        private const int ST_CODE49 = 0x0d;
        private const int ST_MSI = 0x0e;
        private const int ST_EAN128 = 0x0f;
        private const int ST_UPCE1 = 0x10;
        private const int ST_PDF417 = 0x11;
        private const int ST_CODE16K = 0x12;
        private const int ST_C39FULL = 0x13;
        private const int ST_UPCD = 0x14;
        private const int ST_TRIOPTIC = 0x15;
        private const int ST_BOOKLAND = 0x16;
        private const int ST_COUPON = 0x17;
        private const int ST_NW7 = 0x18;
        private const int ST_ISBT128 = 0x19;
        private const int ST_MICRO_PDF = 0x1a;
        private const int ST_DATAMATRIX = 0x1b;
        private const int ST_QR_CODE = 0x1c;
        private const int ST_MICRO_PDF_CCA = 0x1d;
        private const int ST_POSTNET_US = 0x1e;
        private const int ST_PLANET_CODE = 0x1f;
        private const int ST_CODE_32 = 0x20;
        private const int ST_ISBT128_CON = 0x21;
        private const int ST_JAPAN_POSTAL = 0x22;
        private const int ST_AUS_POSTAL = 0x23;
        private const int ST_DUTCH_POSTAL = 0x24;
        private const int ST_MAXICODE = 0x25;
        private const int ST_CANADIN_POSTAL = 0x26;
        private const int ST_UK_POSTAL = 0x27;
        private const int ST_MACRO_PDF = 0x28;
        private const int ST_MACRO_QR_CODE = 0x29;
        private const int ST_MICRO_QR_CODE = 0x2c;
        private const int ST_AZTEC = 0x2d;
        private const int ST_AZTEC_RUNE_CODE = 0x2E;
        private const int ST_FRENCH_LOTTERY = 0x2F;
        private const int ST_RSS14 = 0x30;
        private const int ST_RSS_LIMITET = 0x31;
        private const int ST_RSS_EXPANDED = 0x32;
        private const int ST_PARAMETER_FNC3 = 0x33;
        private const int ST_4STATE_US = 0x34;
        private const int ST_4STATE_US4 = 0x35;
        private const int ST_ISSN = 0x36;
        private const int ST_SCANLET = 0x37;
        private const int ST_CUE_CAT_CODE = 0x38;
        private const int ST_MATRIX_2_OF_5 = 0x39;
        private const int ST_UPCA_2 = 0x48;
        private const int ST_UPCE0_2 = 0x49;
        private const int ST_EAN8_2 = 0x4a;
        private const int ST_EAN13_2 = 0x4b;
        private const int ST_UPCE1_2 = 0x50;
        private const int ST_CCA_EAN128 = 0x51;
        private const int ST_CCA_EAN13 = 0x52;
        private const int ST_CCA_EAN8 = 0x53;
        private const int ST_CCA_RSS_EXPANDED = 0x54;
        private const int ST_CCA_RSS_LIMITED = 0x55;
        private const int ST_CCA_RSS14 = 0x56;
        private const int ST_CCA_UPCA = 0x57;
        private const int ST_CCA_UPCE = 0x58;
        private const int ST_CCC_EAN128 = 0x59;
        private const int ST_TLC39 = 0x5A;
        private const int ST_CCB_EAN128 = 0x61;
        private const int ST_CCB_EAN13 = 0x62;
        private const int ST_CCB_EAN8 = 0x63;
        private const int ST_CCB_RSS_EXPANDED = 0x64;
        private const int ST_CCB_RSS_LIMITED = 0x65;
        private const int ST_CCB_RSS14 = 0x66;
        private const int ST_CCB_UPCA = 0x67;
        private const int ST_CCB_UPCE = 0x68;
        private const int ST_SIGNATURE_CAPTURE = 0x69;
        private const int ST_MATRIX2OF5_OLD = 0x71;
        private const int ST_CHINESE2OF5 = 0x72;
        private const int ST_KOREAN2OF5 = 0x73;
        private const int ST_UPCA_5 = 0x88;
        private const int ST_UPCE0_5 = 0x89;
        private const int ST_EAN8_5 = 0x8a;
        private const int ST_EAN13_5 = 0x8b;
        private const int ST_UPCE1_5 = 0x90;
        private const int ST_MACRO_MICRO_PDF = 0x9A;
        private const int ST_OCRB = 0xA0;
        private const int ST_NEW_COUPON = 0xB4;
        private const int ST_HAN_XIN = 0xB7;
        private const int ST_GS1_DATAMATRIX = 0xC1;
        private const int ST_RFID_RAW = 0xE0;
        private const int ST_RFID_URI = 0xE1;
